;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [179],
  {
      ...
      class z extends _.default.Component {
        ...
        componentDidMount() {
          this.scrollToHash(),
            n.isSsr &&
              (a.isFallback ||
                (a.nextExport && (E.isDynamicRoute(n.pathname) || location.search || Z)) ||
          ...
          i
            ...
            .then(r => {
              ...
              return Promise.resolve(
                (null == (i = e.props) ? void 0 : i.err) ? e.props : j.loadGetInitialProps(t, d)
              ).then(t => ea(y({}, e, { err: l, Component: s, styleSheets: u, props: t })))
            })
        )
      }
      function K(e) {
                ...
                if (
                  ...
                  if (i.startsWith('/')) {
                    ...
                    return Promise.all([
                      ...
                      if (
                        ...
                        (!o &&
                          n.includes(
                            p.normalizeLocalePath(x.removeBasePath(i), r.router.locales).pathname
                          ))
                      ) {
                      ...
                      let u = n.includes(f)
                        ? f
                        : q(
                            p.normalizeLocalePath(x.removeBasePath(c.pathname), r.router.locales)
                              .pathname,
                            n
                          )
                  ...
                  let h = S.parsePath(e),
                    m = M.formatNextPathnameInfo(
                      a({}, R.getNextPathnameInfo(h.pathname, { nextConfig: n, parseData: !0 }), {
                  ...
                  if (v.startsWith('/')) {
                    let b = S.parsePath(v),
                      E = M.formatNextPathnameInfo(
                        a({}, R.getNextPathnameInfo(b.pathname, { nextConfig: n, parseData: !0 }), {
                          defaultLocale: r.router.defaultLocale,
                          buildId: ''
                        })
                      )
        ...
        change(e, t, r, o, i) {
          ...
          return n(function* () {
            ...
            l._inFlightRoute &&
              ...
              (l.clc = null)),
              (r = C.addBasePath(
                w.addLocale(j.hasBasePath(r) ? x.removeBasePath(r) : r, o.locale, l.defaultLocale)
              ))
              ...
              if (en && (!el || es.result))
                el
                  ? (r = b.formatWithValidation(
                      Object.assign({}, ea, { pathname: es.result, query: D(X, es.params) })
                    ))
                  : Object.assign(X, en)
              else {
            ...
            try {
              ...
              if (p && ('/404' === l.pathname || '/_error' === l.pathname)) {
                ...
                try {
                  ...
                  throw (
                    (d.default(ek) && ek.cancelled && J.events.emit('routeChangeError', ek, U, k),
                    ek)
                  )
                }
                return !0
              ...
              if (!eD) {
                ...
                if (ev.error)
                  throw (p || J.events.emit('routeChangeError', ev.error, U, k), ev.error)
        ...
        handleRouteInfoError(e, t, r, a, o, i) {
          ...
          return n(function* () {
            ...
            if (u.isAssetError(e) || i)
              throw (J.events.emit('routeChangeError', e, a, o), $({ url: a, router: l }), T())
            try {
              let n
            ...
            try {
              ...
              let j = !C || 'initial' in C ? void 0 : C,
                ...
                M =
                  g && !y
                    ? null
                    : yield W({ fetchData: () => X(R), asPath: l, locale: c, router: v }).catch(
                        e => {
                          if (g) return null
                          throw e
                        }
              ...
              if (
                ...
                (null == M ? void 0 : null == (_ = M.effect) ? void 0 : _.type) ===
                  'redirect-internal' ||
                  (null == M ? void 0 : null == (P = M.effect) ? void 0 : P.type) ===
                    'redirect-external')
              )
                return M.effect
              if ((null == M ? void 0 : null == (S = M.effect) ? void 0 : S.type) === 'rewrite') {
                ...
                if (
                  ...
                  (l = x.removeBasePath(
                    p.normalizeLocalePath(M.effect.parsedAs.pathname, v.locales).pathname
                  )),
                  (C = v.components[e]),
          ...
          ;(this.sdc = {}),
            ...
            (this.onPopState = e => {
              ...
              if (!n) {
                ...
                this.changeState(
                  'replaceState',
                  b.formatWithValidation({ pathname: C.addBasePath(a), query: o }),
                  m.getURL()
                )
                return
              }
          ...
          if (
            ...
            this._initialMatchesMiddlewarePromise = I({ router: this, locale: f, asPath: E }).then(
              n => (
                ...
                this.changeState(
                  'replaceState',
                  n ? E : b.formatWithValidation({ pathname: C.addBasePath(e), query: t }),
                  E,
                  w
                ),
                n
    ...
    670: function (e, t, r) {
      ...
      t.SP = d
      let f =
        d && ['mark', 'measure', 'getEntriesByName'].every(e => 'function' == typeof performance[e])
      ;(t.ST = f),

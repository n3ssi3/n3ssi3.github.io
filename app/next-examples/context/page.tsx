    ...
    <div className='space-y-4'>
      ...
      <div className='space-y-4'>
        <ul className='list-disc space-y-2 pl-4 text-sm text-zinc-300'>
          <li>
            Pass context <strong>between Client Components</strong> that cross the Server/Client
            Component boundary.
          </li>
          <li>Click the counter and navigate between pages.</li>
          <li>
            Because the context provider is above the nested layouts and pages the number of clicks

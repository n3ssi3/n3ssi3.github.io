    ...
    7561: function (e, t, n) {
      ...
      function s() {
        ...
        ;('string' == typeof t[0] && a[t[0]]) ||
          ('string' == typeof t[0] && (a[t[0]] = new Date()), i.apply(void 0, t))
      }
      function c(e, t, n) {
      ...
      function R(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          u = i.defaultNS,
          l = n || a || r
        if ((l && !l.reportNamespaces && (l.reportNamespaces = new O()), !l)) {
        ...
        var g = L(L(L({}, h), l.options.react), t),
          d = g.useSuspense,
          y = g.keyPrefix,
          v = e || u || (l.options && l.options.defaultNS)
        ;(v = 'string' == typeof v ? [v] : v || ['translation']),
          l.reportNamespaces.addUsedNamespaces && l.reportNamespaces.addUsedNamespaces(v)
        var m =
        ...
        function k() {
          return l.getFixedT(null, 'fallback' === g.nsMode ? v : v[0], y)
        }
        var S = j((0, o.useState)(k), 2),
          w = S[0],
          x = S[1],
          P = v.join(),
          R = N(P),
        ...
        ;(0, o.useEffect)(
          function () {
            C.current && !E.current && x(k), (E.current = !1)
          },
          [l, y]
        )
        var D = [w, l, m]
        if (((D.t = w), (D.i18n = l), (D.ready = m), m || (!m && !d))) return D
      ...
      function C(e) {
        ...
        return (0, o.createElement)(b.Provider, { value: i }, r)
      }
      function E() {
        ...
        B = function (e) {
          ...
          if (p) {
            ...
            if ('string' == typeof h)
              ...
              i.fallbackLng = Object.entries(i.fallbackLng).reduce(function (e, t) {
                var n,
                  r = j(t, 2),
                  o = r[0],
                  i = r[1]
          ...
          return (
            (null == e
              ...
              ('string' == typeof l
                ? (i.backend = {
                    addPath: ''.concat(l, '/').concat(f, '.missing.').concat(c),
                    loadPath: ''.concat(l, '/').concat(f, '.').concat(c)
                  })
                : 'function' != typeof l ||
                  (i.backend = {
            ...
            m(e, [
              ...
              },
              {
                ...
                value: function (t) {
                  return new e(
                    this.logger,
                    Y(Y({}, { prefix: ''.concat(this.prefix, ':').concat(t, ':') }), this.options)
                  )
                }
              },
              {
                    ...
                    : (function e(t, n) {
                        ...
                        if (t) {
                          ...
                          for (var o = n.split(r), i = t, a = 0; a < o.length; ++a) {
                            ...
                            if (void 0 === i[o[a]]) {
                              for (
                                var s = 2, c = o.slice(a, a + s).join(r), u = i[c];
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    if (i && !a) {
                      ...
                      var c = e.split(n)
                      ;(n !== r || (n === r && this.options.ns.indexOf(c[0]) > -1)) &&
                        (o = c.shift()),
                        (e = c.join(r))
                    }
                    ...
                    if (
                      ...
                      if (!t.returnObjects && !this.options.returnObjects) {
                        ...
                        var w = this.options.returnedObjectHandler
                          ? this.options.returnedObjectHandler(v, y, eh(eh({}, t), {}, { ns: l }))
                          : "key '"
                              .concat(c, ' (')
                      ...
                      if (a) {
                        ...
                        for (var L in y)
                          if (Object.prototype.hasOwnProperty.call(y, L)) {
                            ...
                            ;(j[L] = this.translate(N, eh(eh({}, t), { joinArrays: !1, ns: l }))),
                              j[L] === N && (j[L] = y[L])
                          }
                        y = j
                      }
                      ...
                      var R = !1,
                        ...
                        T = t['defaultValue'.concat(I)] || t.defaultValue
                      !this.isValidLookup(y) && D && ((R = !0), (y = T)),
                      ...
                      var F =
                          ...
                          C
                            ? void 0
                            : y,
                        A = D && T !== y && this.options.updateMissing
                      if (C || R || A) {
                        if (
                          (this.logger.log(A ? 'updateKey' : 'missingKey', p, f, c, A ? T : y), a)
                        ) {
                          var V = this.resolve(c, eh(eh({}, t), {}, { keySeparator: !1 }))
                          V &&
                            V.res &&
                            this.logger.warn(
                          ...
                          (this.options.saveMissingPlurals && E
                            ? $.forEach(function (e) {
                                o.pluralResolver.getSuffixes(e, t).forEach(function (n) {
                                  _([e], c + n, t['defaultValue'.concat(n)] || T)
                                })
                              })
                            : _($, c, T))
                      }
                  ...
                  value: function (e, t, n, r, o) {
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse)
                      e = this.i18nFormat.parse(
                        e,
                        eh(eh({}, this.options.interpolation.defaultVariables), n),
                        r.usedLng,
                        r.usedNS,
                        r.usedKey,
                        { resolved: r }
                      ...
                      n.interpolation &&
                        this.interpolator.init(
                          eh(eh({}, n), {
                            interpolation: eh(eh({}, this.options.interpolation), n.interpolation)
                          })
                        )
                      var a,
                        s =
                      ...
                      if (
                        (this.options.interpolation.defaultVariables &&
                          (u = eh(eh({}, this.options.interpolation.defaultVariables), u)),
                      ...
                      e.forEach(function (e) {
                        if (!a.isValidLookup(t)) {
                          ...
                          l.forEach(function (e) {
                            a.isValidLookup(t) ||
                              ((i = e),
                              !ey[''.concat(d[0], '-').concat(e)] &&
                                a.utils &&
                                a.utils.hasLoadedNamespace &&
                                !a.utils.hasLoadedNamespace(i) &&
                                ((ey[''.concat(d[0], '-').concat(e)] = !0),
                                a.logger.warn(
                                  'key "'
                              ...
                              d.forEach(function (n) {
                                if (!a.isValidLookup(t)) {
                                  ...
                                  if (a.i18nFormat && a.i18nFormat.addLookupKeys)
                                    ...
                                    if ((f && (c.push(u + l), p && c.push(u + d)), g)) {
                                      var h = ''
                                        .concat(u)
                                        .concat(a.options.contextSeparator)
                                        .concat(s.context)
                                      c.push(h), f && (c.push(h + l), p && c.push(h + d))
                                    }
                                  }
                                  for (; (i = c.pop()); )
      ...
      var eb = (function () {
                  ...
                  if ('string' == typeof e && e.indexOf('-') > -1) {
                    ...
                    return (
                      this.options.lowerCaseLng
                        ...
                        ? ((n[0] = n[0].toLowerCase()),
                          (n[1] = n[1].toUpperCase()),
                          t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = em(n[1].toLowerCase())))
                        : 3 === n.length &&
                          ((n[0] = n[0].toLowerCase()),
                          2 === n[1].length && (n[1] = n[1].toUpperCase()),
                          'sgn' !== n[0] && 2 === n[2].length && (n[2] = n[2].toUpperCase()),
                          t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = em(n[1].toLowerCase())),
                          t.indexOf(n[2].toLowerCase()) > -1 && (n[2] = em(n[2].toLowerCase()))),
                      n.join('-')
                    )
                  }
        ...
        eS = ['v1', 'v2', 'v3'],
        ew = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
        ex = (function () {
          function e(t) {
            var n,
              ...
              (this.rules =
                ...
                eO.forEach(function (e) {
                  e.lngs.forEach(function (t) {
                    n[t] = { numbers: e.nr, plurals: ek[e.fc] }
                  })
                }),
                n))
          }
          ...
          m(e, [
            {
              ...
              value: function () {
                ...
                ;(this.escape = void 0 !== t.escape ? t.escape : es),
                  (this.escapeValue = void 0 === t.escapeValue || t.escapeValue),
                  (this.useRawValueToEscape =
                    void 0 !== t.useRawValueToEscape && t.useRawValueToEscape),
                  (this.prefix = t.prefix ? ei(t.prefix) : t.prefixEscaped || '{{'),
                  (this.suffix = t.suffix ? ei(t.suffix) : t.suffixEscaped || '}}'),
                  ...
                  (this.nestingPrefix = t.nestingPrefix
                    ? ei(t.nestingPrefix)
                    : t.nestingPrefixEscaped || ei('$t(')),
                  (this.nestingSuffix = t.nestingSuffix
                    ? ei(t.nestingSuffix)
                    : t.nestingSuffixEscaped || ei(')')),
                ...
                var l = function (e) {
                  if (0 > e.indexOf(s.formatSeparator)) {
                    ...
                    return s.alwaysFormat
                      ? s.format(o, void 0, n, eP(eP(eP({}, r), t), {}, { interpolationkey: e }))
                      : o
                  }
                  ...
                  return s.format(
                    ...
                    u,
                    n,
                    eP(eP(eP({}, r), t), {}, { interpolationkey: a })
                  )
                }
                this.resetRegExp()
                var f =
                      ...
                      if (void 0 === (i = l(n))) {
                        if ('function' == typeof f) {
                          ...
                          s.logger.warn(
                            ...
                            (i = '')
                      } else 'string' == typeof i || s.useRawValueToEscape || (i = ee(i))
                      var u = t.safeValue(i)
                      if (
                        ((e = e.replace(o[0], u)),
                        p
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                for (; (n = this.nestingRegexp.exec(e)); ) {
                  var c = []
                  ;((o =
                    (o = eP({}, a)).replace && 'string' != typeof o.replace
                      ? o.replace
                    ...
                    u &&
                      (r = c.reduce(function (e, t) {
                        return i.format(
                          ...
                          t,
                          a.lng,
                          eP(eP({}, a), {}, { interpolationkey: n[1].trim() })
                        )
                      }, r.trim())),
                    (e = e.replace(n[0], r)),
      ...
      var eE = (function () {
        function e() {
          ...
          y(this, e),
            ...
            (this.options = t),
            (this.formats = {
              number: eC(function (e, t) {
                var n = new Intl.NumberFormat(e, t)
                return function (e) {
                  return n.format(e)
                }
              }),
              currency: eC(function (e, t) {
                var n = new Intl.NumberFormat(e, eR(eR({}, t), {}, { style: 'currency' }))
                return function (e) {
                  return n.format(e)
                }
              }),
              datetime: eC(function (e, t) {
                var n = new Intl.DateTimeFormat(e, eR({}, t))
                return function (e) {
                  return n.format(e)
                }
              }),
              relativetime: eC(function (e, t) {
                var n = new Intl.RelativeTimeFormat(e, eR({}, t))
                return function (e) {
                  return n.format(e, t.range || 'day')
                }
              }),
              list: eC(function (e, t) {
                var n = new Intl.ListFormat(e, eR({}, t))
                return function (e) {
                  return n.format(e)
                }
              })
                ...
                return t.split(this.formatSeparator).reduce(function (e, t) {
                  ...
                  if (o.formats[a]) {
                    ...
                    try {
                      ...
                      c = o.formats[a](e, l, eR(eR(eR({}, s), r), u))
                    } catch (e) {
                      o.logger.warn(e)
                    }
                    return c
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                this.queue.forEach(function (n) {
                  var r, s, c, u, l
                  ;((c = (s = et(n.loaded, [o], Object)).obj)[(u = s.k)] = c[u] || []),
                    r && (c[u] = c[u].concat(i)),
                    r || c[u].push(i),
            ...
            },
            {
              ...
              value: function (e, t, n, r, o) {
                var i = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {},
                  a =
                    arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : function () {}
                if (
                  this.services.utils &&
                ...
                if (null != n && '' !== n) {
                  if (this.backend && this.backend.create) {
                    var s,
                      c = eI(eI({}, i), {}, { isUpdate: o }),
                      u = this.backend.create.bind(this.backend)
                    if (u.length < 6)
                      try {
                        ;(s = 5 === u.length ? u(e, t, n, r, c) : u(e, t, n, r)) &&
      ...
      var eU = (function (e) {
        ...
        function r() {
          ...
          if (
            ...
            if (!e.options.initImmediate) return e.init(t, o), J(e, K(e))
            setTimeout(function () {
              e.init(t, o)
            }, 0)
          }
          ...
          m(r, [
            {
              ...
              value: function () {
                ...
                if (
                  ((this.options = e$(e$(e$({}, r), this.options), eA(t))),
                  'v1' !== this.options.compatibilityAPI &&
                    (this.options.interpolation = e$(
                      e$({}, r.interpolation),
                      this.options.interpolation
                    )),
                  ...
                  this.modules.logger
                    ? X.init(o(this.modules.logger), this.options)
                    : X.init(null, this.options),
                    this.modules.formatter
                      ? (i = this.modules.formatter)
                      : 'undefined' != typeof Intl && (i = eE)
                  var i,
                    a = new eb(this.options)
                  this.store = new ep(this.options.resources, this.options)
                  var s = this.services
                  ;(s.logger = X),
                    (s.resourceStore = this.store),
                    (s.languageUtils = a),
                    (s.pluralResolver = new ex(a, {
                ...
                return (
                  this.options.resources || !this.options.initImmediate ? l() : setTimeout(l, 0), u
                )
              }
            },
            {
              ...
              value: function (e) {
                var t = this,
                  n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : eM,
                  r = n,
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  ...
                  'postProcessor' === e.type && eg.addPostProcessor(e),
              ...
              value: function (e, t, n) {
                var r = this,
                  o = function e(t, o) {
                    if ('object' !== u(o)) {
                      for (
                        var i, a, s = arguments.length, c = Array(s > 2 ? s - 2 : 0), l = 2;
                        l < s;
                        l++
                      )
                        c[l - 2] = arguments[l]
            ...
            },
            {
              ...
              value: function () {
                var e = this,
                  t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                  n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : eM,
                  o = e$(e$(e$({}, this.options), t), { isClone: !0 }),
                  i = new r(o)
                return (
                  ...
                  (i.services = e$({}, this.services)),
                  (i.services.utils = { hasLoadedNamespace: i.hasLoadedNamespace.bind(i) }),
                  (i.translator = new ev(i.services, i.options)),
      ...
      f(eU, 'createInstance', function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          t = arguments.length > 1 ? arguments[1] : void 0
        return new eU(e, t)
      })
      var e_ = eU.createInstance()
      ;(e_.createInstance = eU.createInstance),
        e_.createInstance,
        e_.dir,
        e_.init,
        e_.loadResources,
        ...
        e_.t,
        e_.exists,
        e_.setDefaultNamespace,
        e_.hasLoadedNamespace,
        e_.loadNamespaces,
        e_.loadLanguages
      var eB = function (e) {
          void 0 === e.ns && (e.ns = [])
          var t,
            n,
            r = e_.createInstance(e)
          return (
            r.isInitialized
              ? (t = Promise.resolve(e_.t))
              : (null == e ||
                  null === (n = e.use) ||
                  void 0 === n ||
      ...
      var eJ = function (e) {
        ...
        return I()(function (n) {
          var r,
            ...
            s =
              null !== (r = null == a ? void 0 : a.initialLocale) && void 0 !== r
                ? r
                : null == n
                ? void 0
                : null === (i = n.router) || void 0 === i
                ? void 0
                : i.locale,
            c = null == a ? void 0 : a.ns,
            u = (0, o.useMemo)(
              function () {
                if (!a && !t) return null
                var e,
                ...
                if (!(null != n && null !== (e = n.i18n) && void 0 !== e && e.defaultLocale))
          ...
          return null !== u ? eK(C, { i18n: u }, eK(e, n)) : eK(e, E({ key: s }, n))
        }, e)
      }
    },
    6840: function (e, t, n) {

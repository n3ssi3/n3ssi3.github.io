                ...
                ['meta', 'base', 'link', 'style', 'script'].forEach(e => {
                  ;(function (e, t) {
                    ...
                    for (
                      ...
                      var s
                      ;(null == r ? void 0 : null == (s = r.tagName) ? void 0 : s.toLowerCase()) ===
                        e && l.push(r)
                    }
                  ...
                  if (i.startsWith('/')) {
                    ...
                    return Promise.all([
                      ...
                      if (
                        ...
                        (!o &&
                          i.includes(
                            p.normalizeLocalePath(x.removeBasePath(u), r.router.locales).pathname
                          ))
                      ) {
                      ...
                      let c = i.includes(l)
                        ? l
                        : q(
                            p.normalizeLocalePath(x.removeBasePath(t.pathname), r.router.locales)
                              .pathname,
                            i
                          )
                  ...
                  if (c.startsWith('/')) {
                    let e = S.parsePath(c),
                      t = M.formatNextPathnameInfo(
                        a({}, R.getNextPathnameInfo(e.pathname, { nextConfig: n, parseData: !0 }), {
                          defaultLocale: r.router.defaultLocale,
                          buildId: ''
                        })
                      )
          ...
          return n(function* () {
            ...
            let Y = s.removeTrailingSlash(G),
              ...
              Q = !!(
                K &&
                Y !== K &&
                (!g.isDynamicRoute(Y) || !_.getRouteMatcher(P.getRouteRegex(Y))(K))
              ),
              ...
              if (et && (!o || i.result))
                o
                  ? (r = b.formatWithValidation(
                      Object.assign({}, e, { pathname: i.result, query: D(V, i.params) })
                    ))
                  : Object.assign(V, et)
              else {
            ...
            try {
              ...
              if (p && ('/404' === l.pathname || '/_error' === l.pathname)) {
                ...
                try {
                  ...
                  throw (
                    (d.default(e) && e.cancelled && J.events.emit('routeChangeError', e, U, k), e)
                  )
                }
                return !0
              }
            ...
            try {
              ...
              let E = !d || 'initial' in d ? void 0 : d,
                ...
                j =
                  g && !y
                    ? null
                    : yield W({ fetchData: () => X(C), asPath: l, locale: c, router: v }).catch(
                        e => {
                          if (g) return null
                          throw e
                        }
              ...
              if (
                (g &&
                  (j
                    ...
                    : (j = { json: self.__NEXT_DATA__.props })),
                t(),
                (null == j ? void 0 : null == (_ = j.effect) ? void 0 : _.type) ===
                  'redirect-internal' ||
              ...
              if ((null == j ? void 0 : null == (S = j.effect) ? void 0 : S.type) === 'rewrite') {
                ...
                if (
                  ...
                  (l = x.removeBasePath(
                    p.normalizeLocalePath(j.effect.parsedAs.pathname, v.locales).pathname
                  )),
                  (d = v.components[e]),
          ...
          ;(this.sdc = {}),
            ...
            (this.onPopState = e => {
              ...
              if (!n) {
                ...
                this.changeState(
                  'replaceState',
                  b.formatWithValidation({ pathname: C.addBasePath(e), query: t }),
                  m.getURL()
                )
                return
              }
          ...
          if (
            ...
            this._initialMatchesMiddlewarePromise = I({ router: this, locale: f, asPath: a }).then(
              o => (
                ...
                this.changeState(
                  'replaceState',
                  o ? a : b.formatWithValidation({ pathname: C.addBasePath(e), query: t }),
                  a,
                  n
                ),
                o
        ...
        _insert(e, t, n) {
          ...
          if (a.startsWith('[') && a.endsWith(']')) {
            ...
            if (
              ...
              throw Error(
                "Segment names may not start or end with extra brackets ('".concat(r, "').")
              )
            if (r.startsWith('.'))
